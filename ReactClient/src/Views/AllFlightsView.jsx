...
export const AllFlightsView = () => {
    ...
    useEffect(() => {
        ...
        const flights = localLogs.filter((log) => log.legNum === 0).map((log) => {
            return {
                id: log.id,
            ...
            <tbody>
                {
                    ...
                    <tr>
                        <td></td>
                        <td><Center>No flights to show</Center></td>
                        <td></td>
                    </tr>
                    :
                    flightsToRender.reverse().map(log => 
                        <tr key={log.id}>
                            ...
                            <td><Center>{log.legNum === -1 ? "Departed!" : log.legNum}</Center></td>
                            <td>
                                <Center>
